                          ...
                          <div class='span-24'>
                              <div class='menu-secondary-container'>
                                  <ul class='menus menu-secondary'>
                                      ...
                                      <li><a href='./novedades.html' style='background: #e33c17'>IMPORTANTE !</a></li>
...
<br><br>
<div class="titulo">
    <h2>• VACACIONES DE INVIERNO 2023 • </h2>
</div>

  <div class="fila">
    <div class="columna">
        <img style="height: 320px;" src="./img/circo.jpeg">
    </div>
    <div class="columna">
        <img style="height: 260px;" src="./img/circo1.jpeg">
    </div>
    <div class="columna">
        <img style="height: 260px;" src="./img/circo2.jpeg">
    </div>
</div>
<div class="parrafo">
    <p> Una jornada divertida para todas las nenas que forman parte de esta joven Liga.</p>
        <p>    Payasos, ventrilocuos, malabaristas, juegos, música.</p>
            <p>Compartiendo una merienda y disfrutando un gran espectáculo, hermosa tarde!!!
    </p>
</div>
<div class="fila">
    <div class="columna">
        <img style="height: 260px;" src="./img/circo3.jpeg">
    </div>
    <div class="columna">
        <img style="height: 260px;" src="./img/circo4.jpeg">
    </div>
    <div class="columna">
        <img style="height: 260px;" src="./img/circo5.jpeg">
    </div>
</div>
