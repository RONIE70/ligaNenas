                                  ...
                                  <ul class='menus menu-secondary'>
                                      ...
                                      <li><a href='#' style='background: #8f2066;'>GALERIA &#160;&#160;&#160;</a>
                                          <ul class='children'>
                                              ...
                                              <li><a href='./fotosJornada.html'>Jornadas</a></li>
...
<div class="usuRes">
    <br><h2> ENTREGA DE CAMISETAS JULIO 2023 </h2>
	<br><br><br>
    </div>
    <div class="wrapper ">
         <div class="card">
        ...
        <div class="card">
			<img src="./img/2.jpeg"><div class="grid-item2">
         </div>
        </div>
        ...
        <div class="card">
			<img src="./img/5.jpeg"><div class="grid-item1">
          </div>
        </div>

        <div class="card">
			<img src="./img/6.jpeg"><div class="grid-item2">
          </div>
        </div>

        <div class="card">
			<img src="./img/7.jpeg">  <div class=".grid-item2">
          </div>
        </div>

        <div class="card">
			<img src="./img/8.jpeg"><div class=".grid-item2">
         </div>
        </div>

        <div class="card">
			<img src="./img/9.jpeg"><div class=".grid-item2">
          </div>
        </div>
